...
class RespawnPanel extends PanelTemplate {
    constructor () {
        ...
        this.respawnsText = document.createElement('div');
        this.respawnsText.id = 'respawns_value_text';
        this.respawnsText.innerText = _this.player.respawns;
        mainContainer.appendChild(this.respawnsText);
